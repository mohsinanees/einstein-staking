...
module.exports = async function (deployer, network) {
    if (network === "development") {
        ...
        await deployProxy(
            PDOGStaking,
            [pdog.address, pdog.address, (20 * 10 ** 18).toString(), currentTime, 60],
    ...
    if (network === "rinkeby") {
         ...
         * params - _stakeToken, _rewardToken, _rewardRateInWei, _startTime, _rewardIntervalInSeconds
         */
        await deployProxy(EinsteinStaking, [pdog.address, pdog.address, (20 * (10 ** 18)).toString(), currentTime, 60], { deployer, initializer: 'initialize' });
        // const upgraded = await upgradeProxy(
        //     "0x3645D927D0Aa7b2bB2114e864c175Dbed814B5F5",
        //     PDOGStaking,
        //     { deployer }
        // );
    }
